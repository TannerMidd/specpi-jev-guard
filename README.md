...
1. `npm login`, then `npm publish --access public` from `main`.
   (No `--provenance` locally — provenance is generated by the workflow
   on GitHub Actions for all releases after this one.)
